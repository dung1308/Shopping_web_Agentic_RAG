...
class VectorWorkbenchApp(tk.Frame):
    ...
    def _build_header(self):
        ...
        tk.Label(header, text="🔮 Qdrant Hybrid Search & Embeddings Inspector", bg=self.bg_dark, fg=self.text_white, font=("Segoe UI", 16, "bold")).pack(anchor="w")
    ...
    def _build_workbench(self):
        ...
        tk.Label(res_col, text="🎯 Top-5 Similarity Matches (Qdrant Point DB)", bg=self.card_bg, fg=self.text_white, font=("Segoe UI", 11, "bold")).pack(anchor="w", pady=(0, 8))
        ...
        tk.Label(payload_col, text="📄 Qdrant Payload & Dense Vector Array", bg=self.card_bg, fg=self.text_white, font=("Segoe UI", 11, "bold")).pack(anchor="w", pady=(0, 8))
...
if __name__ == "__main__":
    root = tk.Tk()
    root.title("Qdrant Hybrid Search & Embeddings Inspector")
