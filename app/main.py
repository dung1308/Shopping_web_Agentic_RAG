...
from app.vector.chroma_client import init_chroma
from app.api.routers import user, admin, ingest
from app.api.websocket import chat_ws_router
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        logger.warning(f"ChromaDB connection failed during startup: {exc}")
        if not settings.is_dev:
            raise
