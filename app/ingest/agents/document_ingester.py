...
from app.ingest.extractors.chunker import Chunk, HierarchicalChunker
from app.ingest.extractors.docling_extractor import DoclingExtractor
from app.ingest.extractors.playwright_extractor import PlaywrightExtractor
from app.ingest.readers.base_reader import ReadTask, ReadResult
from app.ingest.readers.litellm_reader import LiteLLMReader
...
class DocumentIngester:
    ...
    async def _upsert_to_qdrant(
        ...
        from app.vector.chroma_client import upsert_vectors
